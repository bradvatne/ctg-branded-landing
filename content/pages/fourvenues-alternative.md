...
- **Dayparts and demand pricing.** Morning and afternoon sessions on the same furniture, sunset premiums, event-day rates — dynamic pricing so the same deck earns more on Saturday than Tuesday. The [day club model](https://bradvatne.github.io/ctg-branded-landing/solutions/day-club-booking-system/) runs entirely on this arithmetic.
